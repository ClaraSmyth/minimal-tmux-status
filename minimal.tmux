...
bgPrefix=$(get_tmux_option "@minimal-tmux-bgPrefix" 'default')
...
status_left=$(get_tmux_option "@minimal-tmux-status-left" "#[bg=${bg},fg=${fg},bold]#{?client_prefix,,${indicator}}#[bg=${bgPrefix},fg=${fg},bold]#{?client_prefix,${indicator},}#[bg=default,fg=default,bold]")
